...
<body>
    ...
    <main>
        <h1>Sistema de Login/Cadastro em PHP</h1>
        <div class="box-btn">
            <a class="btn" href="login.php">Login</a>
            <a class="btn" href="cadastro.php">Cadastro</a>
        </div>    
    ...
    <footer>
        <h2>Contato</h2>
        <div class="icons">
            <a href="https://www.instagram.com/felipe_kauan36/" title="Instagram" target="_blank">
            ...
            <a href="https://www.linkedin.com/in/felipekauan/" title="LinkedIn" target="_blank">
            ...
            <a href="https://github.com/felipekauan1/" title="GitHub" target="_blank">
